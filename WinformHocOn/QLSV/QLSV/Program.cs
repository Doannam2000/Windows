...
namespace QLSV
{
    class Program
    {
        ...
        public static List<SinhVien> ReadSV()
        {
            ...
            Stream stream = new FileStream("sinhvien.dat", FileMode.OpenOrCreate, FileAccess.Read);
        ...
        public static Boolean WriteFile(List<SinhVien> sv)
        {
            ...
            Stream stream = new FileStream("sinhvien.dat", FileMode.OpenOrCreate, FileAccess.Write);
            try
            {
